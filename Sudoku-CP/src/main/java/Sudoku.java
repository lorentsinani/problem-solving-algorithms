...
public class Sudoku {
  ...
  /**
   * Build a grid in the form of [row][column]. Where we have a fixed value we just use a simple int var.
   * Where we have a 0 (i.e. an unknown) we put it a bounded int var (from 1->9)
   *
  ...
  private static void printGrid(IntVar[][] grid, boolean showSolution) {
    ...
    // We write the table out with this
